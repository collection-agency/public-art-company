      ...
      <div className='flex flex-col items-center md:justify-between md:h-96 relative py-20'>
        <div className='w-container z-10'>
          <div className='-mx-8 md:flex'>
            <div className='px-8 md:w-1/5 xl:w-1/3'>
        ...
        <div className='h-72 w-container bg-cover bg-center md:h-full md:w-full md:absolute md:inset-0 z-0' style={{ backgroundImage: `url(${imageUrl(image, 960, 960)})` }} role='img' aria-label={image && image.alt}></div>
        {outro &&
          <div className='w-container z-10'>
            <PortableText blocks={outro} renderContainerOnSingleChild className='text-center text-2xl' />
          </div>
        }
      </div>
    </section>
