const Breakpoint = () => {
  return (
    <div className='fixed top-0 right-0 m-8 p-3 text-xs font-sans uppercase text-white h-6 w-6 rounded-full flex items-center justify-center bg-gray-700 sm:bg-pink-500 md:bg-orange-500 lg:bg-green-500 xl:bg-blue-500 z-50'>
